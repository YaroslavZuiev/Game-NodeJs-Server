...
import {mockQuarters} from "./mock-quarters";
...
export class AppComponent implements OnInit {
  ...
  public buildQuarters(quarterCounter: number, iterationQuarter: number, quarterAccumulation: any[], current:number): void {
  ...
  public static validData(data: string[] = []): ValidatorFn {
    return (control: AbstractControl): ValidationErrors | null => {
      const word = data.find(word => word.toLocaleLowerCase() === control.value.toLocaleLowerCase());
